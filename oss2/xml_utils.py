...
def to_put_inventory_configuration(inventory_config):
    ...
    _add_text_child(root, "Id", inventory_config.id)
...
def get_Inventory_configuration_from_element(elem):
    ...
    if root.find("Destination/OSSBucketDestination") is not None:
        ...
        bucket_destination = InventoryBucketDestination(account_id=account_id, role_arn=role_arn, bucket=bucket, 
                inventory_format=inventory_format, prefix=prefix, sse_kms_encryption=sse_kms_encryption)
