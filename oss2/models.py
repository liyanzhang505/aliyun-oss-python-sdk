...
class InventoryConfiguration(object):
    ...
    :param inventory_schedule: 清单的生成计划
...
class InventoryFilter(object):
    ...
    :param prefix: 清单前缀, 生产的清单将会加上这个前缀。
    :type prefix: str
    """
...
class InventorySchedule(object):
    ...
    :param frequency: 生产清单的频率，可以是oss2.models.INVENTORY_FREQUENCY_DAILY 或者 oss2.models.INVENTORY_FREQUENCY_WEEKLY
    :type frequency: str
    """
...
class InventoryBucketDestination(object):
    ...
    :param inventory_format: 生产的清单格式，可以是 oss2.models.INVENTORY_FORMAT_CSV。
    :type inventory_format: str
    
    :param prefix: 生产清单结果的前缀
    :type prefix: str
