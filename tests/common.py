...
OSS_INVENTORY_BUCKET_DESTINATION_ARN = os.getenv("OSS_TEST_INVENTORY_BUCKET_DESTINATION_ARN")
OSS_INVENTORY_BUCKET_DESTINATION_ACCOUNT = os.getenv("OSS_TEST_INVENTORY_BUCKET_DESTINATION_ACCOUNT")
