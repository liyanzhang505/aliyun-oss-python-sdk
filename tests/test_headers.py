...
class TestHeaders(OssTestCase):
    def test_check_requestHeader(self):
        ...
        self.assertTrue(myHeader["x-oss-server-side-encryption"] == "AES256")

        myHeader.set_server_side_encryption(algorithm='KMS')
        self.assertTrue(myHeader["x-oss-server-side-encryption"] == "KMS")
        ...
        self.assertTrue(myHeader["x-oss-server-side-encryption"] == "KMS")
        self.assertTrue(myHeader["x-oss-server-side-encryption-key-id"] == "1111")
