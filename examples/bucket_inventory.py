...
def print_inventory_configuration(configuration):
    ...
    print('inventory_configuration_id', configuration.id)
...
# 获取清单配置
result = bucket.get_bucket_inventory_configuration(configuration_id = configuration_id);
...
# 删除清单配置
bucket.delete_bucket_inventory_configuration(configuration_id)